...
export default function Authenticated({
    ...
    const configActive = Boolean(
        route().current('admin.releases') || route().current('admin.clients.*') || route().current('admin.portaone.*') || route().current('admin.platform-users.*') || route().current('users.*') || route().current('process-runs.*'),
    );
